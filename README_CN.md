...
<a href="https://github.com/reedchan7/kimini/releases/latest"><img src="https://img.shields.io/badge/version-0.3.0-4A90D9?style=flat-square&logo=github" alt="版本 0.3.0"/></a>
...
<a href="#兼容性与发布数据"><img src="https://img.shields.io/badge/local%20tests-186%20passed-brightgreen?style=flat-square&logo=rust" alt="本地 186 项测试通过"/></a>
...
- 原生终端优先使用 daemon 后端；打包后的 daemon 无法加载 PTY 模块时，
  可回退到本地 Rust PTY。
- 两个 0.3.0 arm64 应用可以一起构建和运行；当前构建机上的应用包大小为
  原生 14.1 MiB、Web 1.8 MiB。
...
[tao](https://github.com/tauri-apps/tao) 构建。
