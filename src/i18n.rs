...
pub struct NativeStrings {
    ...
    pub workspace_actions: &'static str,
    pub new_session_in_workspace: &'static str,
    pub copy_path: &'static str,
    pub rename_workspace: &'static str,
    pub remove_workspace: &'static str,
    pub remove_workspace_question: &'static str,
    pub remove_workspace_detail: &'static str,
    ...
    pub copy_session_id: &'static str,
    ...
    pub waiting_for_response: &'static str,
    ...
    pub const fn en() -> Self {
        Self {
            native: NativeStrings {
                ...
                new_session_in_workspace: "New session in this workspace",
                copy_path: "Copy path",
                rename_workspace: "Rename",
                remove_workspace: "Remove workspace",
                remove_workspace_question: "Remove workspace \"{name}\"?",
                remove_workspace_detail: "This unregisters the workspace. Files on disk are kept.",
    ...
    pub const fn zh() -> Self {
        Self {
            native: NativeStrings {
                ...
                new_workspace: "新建工作区",
                workspace_actions: "工作区操作",
                new_session_in_workspace: "在此工作区中新建会话",
                copy_path: "复制路径",
                rename_workspace: "重命名",
                remove_workspace: "移除工作区",
                remove_workspace_question: "移除工作区“{name}”？",
                remove_workspace_detail: "这会注销工作区，磁盘文件将保留。",
                start_session: "Kimi Code",
